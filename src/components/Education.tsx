              ...
              {education.map((item, index) => (
                <div key={index} className="card-cyber rounded-lg p-6 hover-lift glow-border">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span className="text-[10px] font-mono text-primary px-2 py-1 rounded bg-primary/5 border border-primary/20 shrink-0 ml-2 neon-box">
                      {item.year}
                    </span>
                  </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {certifications.map((cert, index) => (
                <div key={index} className="card-cyber rounded-lg p-4 hover-lift group flex items-center gap-4 glow-border">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <Badge variant="outline" className="text-[10px] font-mono border-border/50 hover:border-primary/30">
                      {cert.badge}
                    </Badge>
